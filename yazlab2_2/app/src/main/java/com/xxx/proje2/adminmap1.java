...
import com.xxx.proje2.databinding.ActivityAdminmap1Binding;
import com.xxx.proje2.directionhelpers.FetchURL;
import com.xxx.proje2.directionhelpers.TaskLoadedCallback;

import java.util.ArrayList;

public class adminmap1 extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback, GoogleMap.OnMapClickListener {


    private ActivityAdminmap1Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminmap1Binding.inflate(getLayoutInflater());
        ...
        new FetchURL(adminmap1.this).execute(url,"driving");
        ...
        str = (TextView) findViewById(R.id.sayi1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.addMarker(new MarkerOptions().position(sydney).title("Üni"));
