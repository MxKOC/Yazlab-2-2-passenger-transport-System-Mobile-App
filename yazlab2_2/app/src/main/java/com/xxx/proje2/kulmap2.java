...
import com.xxx.proje2.databinding.ActivityKulmap2Binding;
import com.xxx.proje2.directionhelpers.FetchURL;
import com.xxx.proje2.directionhelpers.TaskLoadedCallback;

public class kulmap2 extends FragmentActivity implements OnMapReadyCallback , TaskLoadedCallback, GoogleMap.OnMapClickListener{

    GoogleMap map;
    MarkerOptions place1,place2;
    Polyline currentPolyline;
    private ActivityKulmap2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKulmap2Binding.inflate(getLayoutInflater());
        ...
        new FetchURL(kulmap2.this).execute(url,"driving");
        ...
        str = (TextView) findViewById(R.id.sayi4);
